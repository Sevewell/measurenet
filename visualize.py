...
def HistMissing(ax, data):
    ...
    ax.hist(size_value, range=(0, 10000), bins=25, alpha=0.5, density=True)
    ax.hist(size_missing, range=(0, 10000), bins=25, alpha=0.5, density=True)


if __name__ == "__main__":

    host = sys.argv[1]
    data = measure.Get(host, 3)
